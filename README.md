...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Tracks key events, user actions, total revenue, and other metrics for just key events. Offers insights into conversion behavior.</td>
    </tr>
    <tr>
      ...
      <td>n/a</td>
      <td>This is a standalone-model that is not built off of the standard GA4 reports. It tracks user sessions across the app or website, summarizing session engagement, start and end times, total events, and more to analyze user behavior during sessions.</td>
    </tr>
  </tbody>
</table>
