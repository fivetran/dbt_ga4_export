...
- Casts `param_ga_session_number` and `derived_session_index` as strings before coalescing as `session_number` in `int_ga4_export__derived_event_fields` to avoid data type collisions.
