...
{% set columns = [
    ...
    {"name": "batch_event_index", "datatype": dbt.type_int()},
    ...
    {"name": "name", "datatype": dbt.type_string(), "quote": True, "alias": "event_name"},
    {"name": "platform", "datatype": dbt.type_string()},
    {"name": "timestamp", "datatype": dbt.type_timestamp(), "quote": True, "alias": "event_timestamp"},
    ...
    {"name": "collected_traffic_source_manual_medium", "datatype": dbt.type_string()},
    {"name": "collected_traffic_source_manual_source", "datatype": dbt.type_string()},
